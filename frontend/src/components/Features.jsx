const features = [
  {
    icon: <span className="material-symbols-rounded">accessible</span>,
    color: "bg-[#1c16cd]/90",
  ...
  {
    icon: <span className="material-symbols-rounded">place</span>,
    color: "bg-[#ff8c2a]",
  ...
  },
  {
    ...
    desc: "Opiniones reales de la comunidad, moderadas con IA para garantizar contenido confiable y respetuoso.",
  },
  {
    icon: <span className="material-symbols-rounded">group</span>,
    color: "bg-[#13da28]",
